...
?>
	<div class="ts-blogs ts-shortcode related-posts related columns-2 ts-slider <?php echo esc_attr($is_slider?'loading':''); ?>">
		<header class="theme-title">
			<h3 class="heading-title"><?php esc_html_e('Related posts', 'stella'); ?></h3>
		</header>
					...
					<div class="article-content">
						...
						<div class="thumbnail-content">
							...
							<span class="vcard author">
								<a class="vcard author" href="<?php echo get_author_posts_url(get_current_user_id()); ?>">
