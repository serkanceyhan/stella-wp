		...
		<div class="header-template">
			...
			<div class="header-top">
				<div class="container">	
					...
					<div class="header-left"><?php stella_store_notices(); ?></div>
					
					<div class="header-right hidden-phone">
						<?php stella_top_header_menu(); ?>
			...
			<div class="header-sticky">
				<div class="header-middle">
					<div class="container">
						...
						<div class="header-center"><div class="logo-wrapper"><?php stella_theme_logo(); ?></div></div>
