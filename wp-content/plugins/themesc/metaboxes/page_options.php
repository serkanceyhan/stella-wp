<?php
$options = array();
$default_sidebars = function_exists('stella_get_list_sidebars')? stella_get_list_sidebars(): array();
...
$footer_blocks = function_exists('stella_get_footer_block_options')? stella_get_footer_block_options(): array();
