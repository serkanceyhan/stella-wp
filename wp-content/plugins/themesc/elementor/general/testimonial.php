...
class TS_Elementor_Widget_Testimonial extends TS_Elementor_Widget_Base{
	...
	protected function register_controls(){
		...
		$this->add_control(
            'content_bg_color'
            ,array(
                'label'     	=> esc_html__( 'Quote Background Color', 'themesky' )
		...
		$this->add_control(
            'content_color'
            ,array(
                'label'     	=> esc_html__( 'Quote Content Color', 'themesky' )
                ,'type'     	=> Controls_Manager::COLOR
				,'default'  	=> '#848484'
				,'selectors'	=> array(
		...
		$this->add_control(
            'meta_color'
            ,array(
                'label'     	=> esc_html__( 'Quote Meta Color', 'themesky' )
                ,'type'     	=> Controls_Manager::COLOR
				,'default'  	=> '#000000'
				,'selectors'	=> array(
					'{{WRAPPER}} blockquote .author-role, {{WRAPPER}} blockquote .rating:before, {{WRAPPER}} blockquote .rating span:before' => 'color: {{VALUE}}'
				)
            )
        );
		...
		$this->add_control(
            'dots_color'
            ,array(
                'label'     	=> esc_html__( 'Bullets Color', 'themesky' )
                ,'type'     	=> Controls_Manager::COLOR
				,'default'  	=> '#000000'
				,'selectors'	=> array(
				...
				while( $testimonials->have_posts() ){
					...
					if( $excerpt_words != -1 ){		
						if( function_exists('stella_the_excerpt_max_words') ){
							$content = stella_the_excerpt_max_words($excerpt_words, $post, true, '', false);
						}
						else{
