...
if( !class_exists('TS_Social_Icons_Widget') ){
	class TS_Social_Icons_Widget extends WP_Widget {
		...
		function widget( $args, $instance ) {
			...
			$logo = '';
			if( $show_logo && function_exists('stella_get_theme_options') ){
			...
			<div class="<?php echo esc_attr( implode(' ', $classes) ); ?>">
				...
				<ul class="list-icons">
					...
					<?php endif; ?>
					<?php if( $viber_number ): ?>
						<li class="viber"><a href="viber://<?php echo esc_attr($viber_number); ?>" target="_blank" title="<?php echo (!$show_tooltip)?esc_html__('Call Us', 'themesky'):''; ?>" ><i class="tb-icon-brand-viber"></i><span class="ts-tooltip social-tooltip"><?php esc_html_e('Viber', 'themesky'); ?></span></a></li>
					<?php endif; ?>
