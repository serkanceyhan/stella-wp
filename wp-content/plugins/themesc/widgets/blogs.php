							...
							<li class="<?php echo $post_format ?>">
								...
								<div class="entry-content">	
									...
									<?php if( $show_excerpt && function_exists('stella_the_excerpt_max_words') ): ?>
										<div class="excerpt">
											<?php stella_the_excerpt_max_words($excerpt_words, $post); ?>
										</div>
									<?php endif; ?>
								...
								<?php else: /* Post format is quote */ ?>
									...
									<blockquote>
										...
										<div class="entry-meta-middle <?php echo $show_author?'show-author':''; ?>">
											...
											<?php if( $show_author ): ?>
											<span class="author">
												<?php esc_html_e('by ', 'themesky'); ?><?php the_author_posts_link(); ?>
											</span>
											<?php endif; ?>
