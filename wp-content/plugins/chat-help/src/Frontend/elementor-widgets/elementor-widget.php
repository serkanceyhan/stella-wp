...
/**
 * Elementor WhatsApp buttons widget.
 *
 * This class handles the creation of a custom Elementor widget 
 * for displaying WhatsApp buttons in the Chat WhatsApp Pro plugin.
 *
 * @since 1.0
 */
class Elementor_Ctw_Buttons extends \Elementor\Widget_Base
{
    ...
    protected function _register_controls()
    {
        ...
        $this->add_control(
            ...
            array(
                'label'        => esc_html__('Open link in new window', 'chat-help'),
        ...
        $this->add_responsive_control(
            'padding',
            array(
                'label'      => esc_html__('Padding', 'chat-help'),
