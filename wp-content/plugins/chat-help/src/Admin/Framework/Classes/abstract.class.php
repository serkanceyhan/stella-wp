...
if ( ! class_exists( 'Chat_Help_Abstract' ) ) {
  abstract class Chat_Help_Abstract {
    ...
    public function __construct() {
      ...
      if ( ! empty( $this->args['output_css'] ) || ! empty( $this->args['enqueue_webfont'] ) ) {
        ...
        Chat_Help::$css = apply_filters( "CHAT_HELP_{$this->unique}_output_css", Chat_Help::$css, $this );
      }
