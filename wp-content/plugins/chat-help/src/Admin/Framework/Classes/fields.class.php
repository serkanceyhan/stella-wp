 ...
 *
 */
if ( ! class_exists( 'CHAT_HELP_Fields' ) ) {
  abstract class CHAT_HELP_Fields extends Chat_Help_Abstract {
    protected $field;
    protected $value;
    protected $unique;
    protected $where;
    ...
    public function field_before() {
      return ( ! empty( $this->field['before'] ) ) ? '<div class="chat-help-before-text">'. $this->field['before'] .'</div>' : '';
    }

    public function field_after() {

      $output  = ( ! empty( $this->field['after'] ) ) ? '<div class="chat-help-after-text">'. $this->field['after'] .'</div>' : '';
      $output .= ( ! empty( $this->field['desc'] ) ) ? '<div class="clear"></div><div class="chat-help-desc-text">'. $this->field['desc'] .'</div>' : '';
      $output .= ( ! empty( $this->field['help'] ) ) ? '<div class="chat-help-help"><span class="chat-help-help-text">'. $this->field['help'] .'</span><i class="icofont-question-circle"></i></div>' : '';
      $output .= ( ! empty( $this->field['_error'] ) ) ? '<div class="chat-help-error-text">'. $this->field['_error'] .'</div>' : '';
