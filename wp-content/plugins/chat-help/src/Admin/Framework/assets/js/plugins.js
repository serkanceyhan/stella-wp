...
(function($) {
  ...
  function chat_help_AjaxChosen(element, options) {
    this.element = $(element);
    this.options = options;
    this.init();
  };

  chat_help_AjaxChosen.prototype.init = function() {
  ...
  chat_help_AjaxChosen.prototype.events = function() {
  ...
  chat_help_AjaxChosen.prototype.search_field_focused = function() {
  ...
  chat_help_AjaxChosen.prototype.search_welcome_message = function() {
  ...
  chat_help_AjaxChosen.prototype.update_list = function() {
    ...
    this.timer = setTimeout( function() {
      ...
      _this.chosenXhr = window.wp.ajax.post('chat-help-chosen', _this.options.data).done( function( response ) {
  ...
  chat_help_AjaxChosen.prototype.show_results = function( items ) {
    ...
    if( this.is_multiple ) {
      ...
      var $hidden_select = this.element.parent().find('.chat-help-hide-select');
      var $hidden_value  = $hidden_select.val() || [];

      this.element.chat_help_ChosenOrder($hidden_value, true);
  ...
  $.fn.chat_help_AjaxChosen = function(chosenOptions) {
    return this.each(function() {
      new chat_help_AjaxChosen(this, chosenOptions);
    });
  };
...
(function() {
  var $, ChatHelpAbstractChosenOrder, _ref,
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  ChatHelpAbstractChosenOrder = (function() {

    function ChatHelpAbstractChosenOrder() {}

    ChatHelpAbstractChosenOrder.insertAt = function(node, index, parentNode) {
      return parentNode.insertBefore(node, parentNode.children[index].nextSibling);
    };

    ChatHelpAbstractChosenOrder.getFlattenedOptionsAndGroups = function(select) {
    ...
    ChatHelpAbstractChosenOrder.isValidMultipleSelectElement = function(element) {
      return element !== null && typeof element !== "undefined" && element.nodeName === "SELECT" && element.multiple;
    };

    ChatHelpAbstractChosenOrder.getChosenUIContainer = function(select) {
      if (select.id !== "") {
    ...
    ChatHelpAbstractChosenOrder.isChosenified = function(select) {
      return this.getChosenUIContainer(select) != null;
    };

    ChatHelpAbstractChosenOrder.forceSelection = function(select, selection) {
    ...
    ChatHelpAbstractChosenOrder.chat_help_ChosenOrder = function(select, order, force) {
    ...
    return ChatHelpAbstractChosenOrder;
  ...
  $.fn.extend({
    chat_help_ChosenOrder: function(order, force) {
      return _chat_help_ChosenOrder.chat_help_ChosenOrder(this, order, force);
    }
  });

  this._chat_help_ChosenOrder = (function(_super) {
    __extends(_chat_help_ChosenOrder, _super);

    function _chat_help_ChosenOrder() {
      _ref = _chat_help_ChosenOrder.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    _chat_help_ChosenOrder.relAttributeName = 'data-option-array-index';

    _chat_help_ChosenOrder.isjQueryObject = function(obj) {
      return (typeof jQuery !== "undefined" && jQuery !== null) && obj instanceof jQuery;
    };

    _chat_help_ChosenOrder.getDOMElement = function(element) {
    ...
    _chat_help_ChosenOrder.searchChosenUIContainer = function(element) {
    ...
    _chat_help_ChosenOrder.triggerEvent = function(target, event_name) {
      return $(target).trigger(event_name);
    };

    return _chat_help_ChosenOrder;

  })(ChatHelpAbstractChosenOrder);
    ...
    applyRule: function(context, enforced) {
      ...
      if( result ) {
        ...
        $(controls).each(function() {
          $(this).removeClass('chat-help-depend-on');
        });
        ...
        $(controls).each(function() {
          $(this).addClass('chat-help-depend-on');
        });
...
(function(root, factory) {
  ...
  if (typeof $.fn !== "undefined") {
    $.fn.serializeObject_chat_help = FormSerializer.serializeObject;
    $.fn.serializeJSON_chat_help   = FormSerializer.serializeJSON;
  }
