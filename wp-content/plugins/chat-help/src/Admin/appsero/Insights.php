...
class Insights
{
    ...
    public function admin_notice()
    {
        ...
        if (empty($this->notice)) {
            $notice = sprintf($this->client->chat_help_trans('Want to help make <strong>%1$s</strong> even more awesome? Allow %1$s to collect non-sensitive diagnostic data and usage information.'), $this->client->name);
        } else {
            $notice = $this->notice;
        }
        ...
        $notice .= ' (<a class="' . $this->client->slug . '-insights-data-we-collect" href="#">' . $this->client->chat_help_trans('what we collect') . '</a>)';
        ...
        echo '&nbsp;<a href="' . esc_url($optin_url) . '" class="button-primary button-large">' . wp_kses_post($this->client->chat_help_trans('Allow')) . '</a>';
        echo '&nbsp;<a href="' . esc_url($optout_url) . '" class="button-secondary button-large">' . wp_kses_post($this->client->chat_help_trans('No thanks')) . '</a>';
        echo '</p></div>';
    ...
    private function get_uninstall_reasons()
    {
        $reasons = array(
            array(
                ...
                'text'        => $this->client->chat_help_trans("Couldn't understand"),
                'placeholder' => $this->client->chat_help_trans('Would you like us to assist you?'),
            ...
            array(
                ...
                'text'        => $this->client->chat_help_trans('Found a better plugin'),
                'placeholder' => $this->client->chat_help_trans('Which plugin?'),
            ...
            array(
                ...
                'text'        => $this->client->chat_help_trans("Missing a specific feature"),
                'placeholder' => $this->client->chat_help_trans('Could you tell us more about that feature?'),
            ...
            array(
                'id'          => 'is-not-working',
                'text'        => $this->client->chat_help_trans('Not working'),
                'placeholder' => $this->client->chat_help_trans('Could you tell us a bit more whats not working?'),
            ...
            array(
                ...
                'text'        => $this->client->chat_help_trans("Not what I was looking"),
                'placeholder' => $this->client->chat_help_trans('Could you tell us a bit more?'),
            ...
            array(
                ...
                'text'        => $this->client->chat_help_trans("Didn't work as expected"),
                'placeholder' => $this->client->chat_help_trans('What did you expect?'),
            ...
            array(
                'id'          => 'other',
                'text'        => $this->client->chat_help_trans('Others'),
                'placeholder' => $this->client->chat_help_trans('Could you tell us a bit more?'),
                                ...
                                <label>
                                    ...
                                    <div class="wd-de-reason-icon">
                                        <?php
                                            ...
                                            echo wp_kses($reason['icon'], $allowed_svg_tags);
                                            ?>
                                    </div>
