 ...
 * Description:       Remove Add to Cart Button for WooCommerce Plugin gives you a really easy interface to hide/remove the Product Add to Cart button for all users or only for the visitors. It has an option to hide the product price, also.
 * Version:           2.1.7
 * Author:            wpArtisan
...
if ( function_exists( 'ratcbw_fs' ) ) {
     ...
     */
    define( 'REMOVE_ADD_TO_CART_BUTTON_WOOCOMMERCE_VERSION', '2.1.7' );
