...
use Bunny_WP_Plugin\GuzzleHttp\Cookie\CookieJarInterface;
...
use Bunny_WP_Plugin\Psr\Log\LoggerInterface;
/**
        ...
        return static function (callable $handler) : callable {
            return static function ($request, array $options) use($handler) {
                if (empty($options['cookies'])) {
                    ...
                    throw new \InvalidArgumentException('Bunny_WP_Plugin\\cookies must be an instance of GuzzleHttp\\Cookie\\CookieJarInterface');
                }
